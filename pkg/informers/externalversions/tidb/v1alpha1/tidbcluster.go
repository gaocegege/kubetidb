	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubetidbV1alpha1().TiDBClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubetidbV1alpha1().TiDBClusters(namespace).Watch(options)
			},
		},
		&tidb_v1alpha1.TiDBCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tiDBClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tidb_v1alpha1.TiDBCluster{}, f.defaultInformer)
}
